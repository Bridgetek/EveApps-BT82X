...
//
//#define GRAPH_BYTE_PER_LINE   8 // l1 8 bit per line, value 0-255
...
//	EVE_Cmd_wr32(s_pHalContext, BITMAP_LAYOUT(BARGRAPH, graph->w, l1_H));
//	EVE_Cmd_wr32(s_pHalContext, BITMAP_SIZE(NEAREST, BORDER, BORDER, graph->w, l1_H));
//	EVE_Cmd_wr32(s_pHalContext, BITMAP_SIZE_H(graph->w >> 9, l1_H >> 9));
//
//	// display bitmap
